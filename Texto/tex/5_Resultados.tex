...
\figura[!h]{prova4.png}{Registros de sensor em um período de dez minutos}{prova4}{scale=0.7}
...
\figura[!h]{prova5.jpg}{QR-Codes localizados próximos aos sensores}{prova5}{width=\textwidth, height=250}
...
\figura[!h]{prova6.jpg}{Exemplo de pergunta apresentada ao colaborador}{prova6}{scale=0.17}
\figura[!h]{prova7.jpg}{Exemplo de um conjunto de respostas possíves apresentadas ao colaborador}{prova7}{scale=0.17}
...
\figura[!h]{prova8.png}{Lista de dispositivos}{prova8}{scale=0.17}
...
\figura[!h]{prova9.png}{Últimas leituras e pontuação do sensor}{prova9}{scale=0.17}
\figura[!h]{prova10.png}{Gráficos com a média das leituras das últimas 24 horas}{prova10}{scale=0.17}
\figura[!h]{prova11.png}{Gráficos com a média histórica das leituras}{prova11}{scale=0.17}
