...
\\ \null \qquad Ao estudar a qualidade do equipamento que coleta os dados em um ambiente, estuda-se, indiretamente, a qualidade do dado gerado, visto que um sensor confiável tem a tendência de gerar dados de boa qualidade.
\section{Objetivos}
\label{sec:objetivo}
