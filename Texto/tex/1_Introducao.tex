...
\section{dados}%
  ...
  é determinada pela de acordo com o domínio da aplicação \cite{IOTdata}. Consequentemente, modelos de suporte à decisão são construídos
  ...
  \subsection{Metadados de sensores}
    ...
    \end{itemize}
     ...
     A Linguagem de Modelagem de Sensores \cite{SML} é uma coleção de padrões
    desenvolvida para representar informações de sensores em formato XML.
