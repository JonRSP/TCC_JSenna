...
\subparagraph{}
 Foram escolhidas as seguintes bases digitais devido a sua relevância e sua grande abrangência sobre diversos temas:
\begin{itemize}
...
\begin{itemize}
  \item O texto integral do trabalho deve estar disponível nas bases de dados escolhidas previamente;
...
\begin{itemize}
  \item Trabalhos publicados anteriormente à 2008, exceto fontes relevantes que contenham definições pertinentes a este estudo;
  \item Trabalhos parcialmente disponíveis nas bases de dados digitais escolhidas, ou seja, publicações não disponíveis gratuitamente;
...
\\\null \quad Após a utilização da \textit{string} de busca e das fases II e III, foi obtido um total de 20 estudos significativos,
