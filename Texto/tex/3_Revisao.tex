...
\quad Este capítulo descreve os métodos utilizados para a aquisição da bibliografia utilizada. Foi definido um processo baseado no método de revisão sistemática apenas para que fosse seguido um protocolo para a aquisição de referências bibliográficas. Esta revisão consiste em três fases:
\begin{itemize}
  \item Planejar;
  \item Executar;
  \item Documentar.
...
\quad Os artigos obtidos por meio da estratégia acima descrita passaram por um processo de avaliação metódica, com base nos critérios anteriormente especificados.
