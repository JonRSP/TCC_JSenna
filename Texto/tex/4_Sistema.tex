...
\figura[!h]{inicial.png}{Página inicial do site}{inicial}{scale=0.3}
...
\figura[!h]{principal.png}{Página principal do site}{principal}{scale=0.38}
...
\figura[!h]{pSensor.png}{Página de detalhes de um sensor}{pSensor}{scale=0.38}
...
\figura[!h]{pergunta.png}{Página com uma pergunta aleatória referente ao sensor}{pergunta}{scale=0.4}
...
\figura[!h]{sqn202.jpg}{Montagem inicial dos sensores}{sqn202}{scale=0.6}
