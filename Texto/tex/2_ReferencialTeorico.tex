O trabalho visa a avaliação e classificação de
dispositivos categorizados em \acrfull{IoT}. %expandir
...
Segundo o dicionário, temos as seguintes definições:%referência do dicionário
\begin{itemize}
...
que humanos e máquinas aumentem sua capacidade de perceber, discriminar e avaliar dados e informações dos ambientes ao seu arredor.
 ...
 com capacidade comunicativa, conforme mostra a imagem \ref{refaxisiot}.
  \figura[!h]{axisiot.png}{Nova dimensão introduzida em comunicações\cite{IOTS}}{refaxisiot}{scale=0.5}%
\\ \null
 \quad
 A \acrlong{IoT} surgiu a partir de um cojunto de diferentes visões como é possível observar na figura \refFig{refiotvision}, cada qual com seus objetivos específicos. %expandir
 \pagebreak
...
\subsection{Definição}
  ...
  \quad	No documento produzido pela \acrshort{ITU}, foram consolidadadas as seguintes definições:
	...
	de tecnologias de comunicação e informação" \cite{ITU};%tradução livre
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \figura[!h]{RaspB.png}{Placa de desenvolvimento Raspberry Pi modelo B+ \cite{RaspB}}{figRaspB}{scale=0.32}%
  \end{itemize}
  %\pagebreak
